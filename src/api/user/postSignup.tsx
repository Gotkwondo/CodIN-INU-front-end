...
export const PostSignup = async (email:string|string[] , nickname:string, profileImage:File ): Promise<any> => {
  ...
  try { 
    ...
    formData.append('userProfileRequestDto ', JSON.stringify(userProfileRequestDto));
