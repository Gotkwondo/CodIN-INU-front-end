...
<div>
                코딘 개인 정보 처리 방침
                문의사항은 inu.codin@gmail.com  으로 연락 주시길 바랍니다.
                ...
                본 이용약관은 “CodIN”(이하 "코딘")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
                ...
                ② 이용계약 : 서비스 이용과 관련하여 사이트와 회원간에 체결 하는 계약을 말합니다.
                ...
                서비스 및 운영자는 회원가입 시 제공한 개인정보 중 비밀번호를 가지고 있지 않으며 이와 관련된 부분은 서비스의 개인정보처리방침을 따릅니다.
                ...
                ② 운영자는 계속적이고 안정적인 서비스 제공을 위하여 설비에 장애가 생기거나 유실된 때에는 이를 지체 없이 수리 또는 복구할 수 있도록 서비스에 요구할 수 있습니다. 다만, 천재지변 또는 서비스나 운영자에 부득이한 사유가 있는 경우, 사이트 운영을 일시 정지할 수 있습니다.


                제8조 회원의 의무


                ① 회원은 본 약관에서 규정하는 사항과 운영자가 정한 제반 규정, 공지사항 및 운영정책 등 서비스가 공지하는 사항 및 관계 법령을 준수하여야 하며, 기타 사이트의 업무에 방해가 되는 행위, 서비스의 명예를 손상하는 행위를 해서는 안 됩니다.

                ② 회원은 서비스의 명시적 동의가 없는 한 서비스의 이용 권한, 기타 이용계약상 지위를 타인에게 양도, 증여할 수 없으며, 이를 담보로 제공할 수 없습니다.

                ③ 이용고객은 아이디 및 비밀번호 관리에 상당한 주의를 기울여야 하며, 운영자나 서비스 동의 없이 제3자에게 아이디를 제공하여 이용하게 할 수 없습니다.
                ...
                ① 서비스 이용 시간은 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간을 원칙으로 합니다. 단, 서비스는 시스템 정기점검, 증설 및 교체를 위해 운영자가 정한 날이나 시간에 서비스를 일시중단 할 수 있으며 예정된 작업으로 인한 서비스 일시 중단은 서비스의 메인 페이지에 사전에 공지하오니 수시로 참고하시길 바랍니다.
                ...
                ① 서비스의 게시물과 자료의 관리 및 운영의 책임은 운영자에게 있습니다. 운영자는 항상 불량 게시물 및 자료에 대하여 모니터링을 하여야 하며, 불량 게시물 및 자료를 발견하거나 신고를 받으면 해당 게시물 및 자료를 삭제하고 이를 등록한 회원에게 주의를 주어야 합니다.
                ...
                ① 운영자는 회원이 서비스 제공으로부터 기대되는 이익을 얻지 못하였거나 서비스 자료에 대한 취사선택 또는 이용으로 발생하는 손해 등에 대해서는 책임이 면제됩니다.

                ② 운영자는 본 서비스 기반 및 타 통신업자가 제공하는 전기통신 서비스의 장애로 인한 경우에는 책임이 면제되며 본 서비스 기반과 관련되어 발생한 손해에 대해서는 서비스의 이용약관에 준합니다
